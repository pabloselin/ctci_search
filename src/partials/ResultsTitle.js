				...
				<div className="resultsDetail">
					...
					<p className="yearRange">
						{this.props.title.start_year && (
							<span>
								desde{" "}
								<strong>{this.props.title.start_year}</strong>
							</span>
						)}
						{this.props.title.end_year && (
							<span>
								hasta{" "}
								<strong>{this.props.title.end_year}</strong>
							</span>
						)}
					</p>
					...
					{this.props.title.terms && (
						<>
							...
							/>
							<ResultsDetail
								content={this.props.title.terms.docauthor}
								label={"Autor"}
							/>
							<ResultsDetail
							...
							/>
							<ResultsDetail
								content={this.props.title.terms.docpilar}
								label={"Pilar Estratégico"}
							/>
							<ResultsDetail
								content={this.props.title.terms.post_tag}
								label={"Etiqueta"}
							/>
						</>
					)}
